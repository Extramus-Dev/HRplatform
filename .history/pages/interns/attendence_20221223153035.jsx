...
function Attendence() {
  ...
  if (!data) return <p>No profile data</p>;
    ...
    var statusOfTheDay = attendance.statusOfTheDay;
    var present = attendance.present;
    var late = attendance.late;
    var dayOff = attendance.dayOff;
    var excusedLeave = attendance.excusedLeave;
    var sick = attendance.sick;
    var unexcusedleave = attendance.unexcusedleave;
