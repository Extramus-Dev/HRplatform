        ...
        <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded">
          ...
          <div className="flex justify-between rounded-t mb-0 px-4 py-6 border-0 bg-white">
            ...
            <div className="flex gap-2">
              ...
              <span className="hover:bg-blue-400 group flex items-center rounded-md bg-blue-500 text-white text-xs font-light pl-2 pr-3 py-2 shadow-sm cursor-pointer">
              <CheckCircle className="h-6 fill-[#0b3768] " />
                Save
              </span>
            </div>
            </div>
